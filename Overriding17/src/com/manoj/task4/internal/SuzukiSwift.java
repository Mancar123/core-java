...
public class SuzukiSwift {
        ...
        public String toString(){
            System.out.println("running toString in SuzukiSwift");
            return "Owner:" + this.Owner + ", price:" + this.price + ", carType:" + this.cartype + ", torque:" + this.torque;
        }

        public boolean equals(Object obj){
            if(obj != null && obj instanceof SuzukiSwift){
                SuzukiSwift s = (SuzukiSwift)obj;
                if(Objects.equals(s.Owner, this.Owner)){
                    System.out.println("SuzukiSwift car is matching");
                    return true;
                }
            }
            return false;
